...
namespace mssm.Migrations
{
    ...
    [Migration("20240529161416_MigrateDBv1")]
    partial class MigrateDBv1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("mssm.Models.ProjectModel.TaskModel", b =>
                {
                    ...
                    b.HasOne("mssm.Models.ProjectModel.TypeTask", "Type")
                        .WithOne("task")
                        .HasForeignKey("mssm.Models.ProjectModel.TaskModel", "TypeId");
